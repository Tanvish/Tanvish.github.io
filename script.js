...
, '', 'BETA', function(r) {
 ...
 $(document).ready( function() {
  $("#ran73").click( function() {
    jPrompt('The first experiment in modern day biochemistry (organic) was carried out by Fredriech Wohler who synthesised an organic compound X from inorganic compounds. Identify X.',
     '', 'BETA', function(r) {
